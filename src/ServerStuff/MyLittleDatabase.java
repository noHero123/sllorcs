...
public class MyLittleDatabase {
	...
	private MyLittleDatabase()
	{
	 ...
	 private void addDefaultDecks(long playerid)
	 {
		 ...
		 toadd.add(deck1);
		 deck1 = "{\"deck\":\"EnergySet3\",\"author\":\"Mojang\",\"types\":[1,2,25,32,67,77,81,82,107,130,138,139,145,146,160]}"	;
		 toadd.add(deck1);
		 ...
		 toadd.add(deck1);
		 deck1 = "{\"deck\":\"GrowthSet3\",\"author\":\"Mojang\",\"types\":[21,22,26,30,33,42,45,53,58,65,75,78,104,117,156]}" ;
		 toadd.add(deck1);
		 ...
		 toadd.add(deck1);
		 deck1 = "{\"deck\":\"OrderSet3\",\"author\":\"Mojang\",\"types\":[50,51,62,64,74,92,95,105,116,121,122,123,155,157,193]}" ;
		 toadd.add(deck1);
		 ...
		 toadd.add(deck1);
		 deck1 = "{\"deck\":\"DecaySet5\",\"author\":\"Mojang\",\"types\":[260,264,265,266,267,268,269,270,271,272,276,278,279,309,319]}";
		 toadd.add(deck1);
		 deck1 = "{\"deck\":\"EnergySet5\",\"author\":\"Mojang\",\"types\":[262,277,281,282,283,284,285,286,287,288,299,300,301,317,318]}";
		 toadd.add(deck1);
